...
public class ListaDispositivos extends AppCompatActivity {
    ...
    private AdapterDispositivos mAdapter;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        mAdapter = new AdapterDispositivos(this);
    ...
    private AdapterDispositivos.OnPairButtonClickListener listenerBotonEmparejar = new AdapterDispositivos.OnPairButtonClickListener() {
        @Override
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_BOND_STATE_CHANGED.equals(action))
            {
                ...
                if (state == BluetoothDevice.BOND_BONDED && prevState == BluetoothDevice.BOND_BONDING)
                {
                    ...
                    Intent i = new Intent(ListaDispositivos.this, Seleccion.class);
